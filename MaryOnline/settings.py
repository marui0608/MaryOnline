"""
Django settings for MaryOnline project.
...
SECRET_KEY = '__7%+%h)of(3@g$16w5)%%_po&j%d(y+v1c6pgy&y2g&upnm8-'
...
WSGI_APPLICATION = 'MaryOnline.wsgi.application'
